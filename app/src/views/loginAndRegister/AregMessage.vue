      ...
      <div class="regMessage-box">
        ...
        <div class="regMessage-footer">
          ...
          <span>
            ...
            <span class="el-icon-arrow-right" @click="backTop"></span>
          </span>
        </div>
      </div>
    </transition>
          ...
          if (valid) {
            ...
            Fillmsg({
              ...
              if (resp.data.code === 1) {
                ...
                ARegisterSuccess.storeName = this.$cookies.get('registerEmail')
                ARegisterSuccess.email = this.$cookies.get('registerStoreName')
