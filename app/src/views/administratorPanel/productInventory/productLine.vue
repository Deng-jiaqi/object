      ...
      <div class="allProducts" v-if="judgeNum > 0"  v-loading="loading">
        ...
        <div class="header-search">
          ...
          <div class="div-search">
            <input class="search" v-model="search" :placeholder="$t('productLine.header.search')" @input="souSuo" />
            ...
            <el-popover
              ...
              <div class="btn1-bianJi">
                <ul>
                  <li v-for="(item,index) in $t('productLine.list')" :key="index" @click="clickmsg(item, index)">{{item.text}}</li>
                </ul>
              </div>
        ...
        <div class="inventory-table" v-loading="loading">
          <table v-if="judgeLength > 0">
            ...
            <th>{{$t('productLine.table.thead.th1')}}</th>
            ...
            <tr v-for="(item, index) in products" :key="index" @click="routerDetail(item)">
              <td>
                <input type="checkbox"
                       ...
                       class="check_box tui-checkbox" @click.stop />
              </td>
              <td width="200px">
                <div class="title-Box">
                  <div>
