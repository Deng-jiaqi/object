    ...
    <div class="productDetails-form">
      <el-form :model="ruleForm" :rules="rules" validate-on-rule-change ref="ruleForm" class="add-form">
        ...
        <el-form-item>
          ...
          <div class="add-type">
            <el-form-item>
              <el-radio v-model="radio" label="1" class="radioCss">{{$t('addProductLine.content.span2')}}</el-radio>
              <p class="proCaoZuo">{{$t('addProductLine.content.span3')}}
                <el-link>{{$t('addProductLine.content.span4')}}</el-link>
              </p>
            </el-form-item>
            <el-form-item>
              <el-radio v-model="radio" label="2" class="radioCss">{{$t('addProductLine.content.span5')}}</el-radio>
          ...
          <div v-if="radio !== '1'">
            ...
            <p>{{$t('addProductLine.content.span9')}}
              <el-radio v-model="radioTwo" label="1" class="radioCss">{{$t('addProductLine.content.span10')}}</el-radio>
              <el-radio v-model="radioTwo" label="2" class="radioCss">{{$t('addProductLine.content.span11')}}</el-radio>
            </p>
            <div class="addIf">
    ...
    saveForm (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          this.$message({
            message: this.$t('addProductLine.hint.text1'),
            type: 'warning'
          })
        }
      })
