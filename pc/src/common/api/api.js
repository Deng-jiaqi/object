...
// 进入在线商品显示模板名称和模板图片，路由
export const showMoudel = (data) => {
  return ajax.post('/Shop/public/index.php/template/handel/show', data)
}
// 更新用户信息后，更新头像及用户昵称si
export const upDateHeadImg = (data) => {
  return ajax.post('/Shop/public/index.php/basic/account/updateheadimg', data)
}
// 进入在线商品显示模板名称和模板图片，路由
export const exsitingMoudel = (data) => {
  return ajax.post('/Shop/public/index.php/template/handel/overview', data)
}
// 保存卖家选中的模板
export const saveMoudel = (data) => {
  return ajax.post('/Shop/public/index.php/template/handel/saveselect', data)
}
// =======================================================
...
export const productDetails = (data) => {
  return ajax.post('/Shop/public/index.php/Buyer/Goodsdetail/goodsinfo', data)
}
// 买家加入购物车
...
export const paymoney = (data) => {
  return ajax.post('/Shop/public/index.php/payment/handel/pay', data)
}
//   paypal支付
export const showpaypalmoney = (data) => {
  return ajax.post('/Shop/public/index.php/payment/handel/showpaypal', data)
}
// 提交订单验证库存是否足够
...
export const paysave = (data) => {
  return ajax.post('/Shop/public/index.php/basic/payconfig/save', data)
}
// 网页端设置查询支付参数
export const payShow = (data) => {
  return ajax.post('/Shop/public/index.php/basic/payconfig/show', data)
}
// ================================设置 > 运输
...
export const getTransportInformation = (params) => { // 获取运输资料信息
  return ajax.get('/Shop/public/index.php/basic/Transport/rateList', params)
}
// =========================================================================
// 登录注册
...
export const forgetEmailpassword = (data) => {
  return ajax.post('/Shop/public/index.php/User/Forget/forgetmailpwd', data)
}
export const resetEmailpassword = (data) => {
  return ajax.post('/Shop/public/index.php/User/Forget/resetmailpwd', data)
}
...
// 卖家订单中线下付款的点击确认收款
export const receipt = (data) => { // 获取订单列表
  return ajax.post('/Shop/public/index.php/order/allorder/receipt', data)
}
...
//  *************************************************************************
// *************************模板设置*********************************************
export const getCustomSidebarData = (data) => { // 获取自定义侧边栏数据
  return ajax.post('/Shop/public/index.php/template/handel/showsidebar', data)
}
export const getSeriesOfProduct = (data) => { // 侧边栏获取店铺下所有产品系列的信息
  return ajax.post('/Shop/public/index.php/buyer/Index/collectionlist', data)
}
export const savecustomize = (data) => { // 获取店铺下所有产品系列的信息
  return ajax.post('/Shop/public/index.php/template/handel/savecustomize', data)
}
export const getCatalogInfo = (data) => { // 获取店铺下cattlog页信息
  return ajax.post('/Shop/public/index.php/Buyer/index/catalogpage', data)
}
//  *************************************************************************
// *************************商店数据*********************************************
export const getStoreFrontPageData = (data) => { // 获取商店首页数据
  return ajax.post('/Shop/public/index.php/buyer/Index/homepage', data)
}
export const getAllSeriesOfProductListData = (data) => { // 获取商店所有产品系列的数据
  return ajax.post('/Shop/public/index.php/buyer/Index/collectionlistpage', data)
}
export const updateShoppingCartQuantity = (data) => { // 更新购物车数量
  return ajax.post('/Shop/public/index.php/Buyer/Shopcart/update', data)
}
// 主页联系我们
export const concatusData = (data) => {
  return ajax.post('/Shop/public/index.php/User/register/concatus', data)
}
