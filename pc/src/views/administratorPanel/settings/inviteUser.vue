    ...
    <div class="inviteUser-box">
      ...
      <div class="inviteUser-form">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
          ...
          <el-form-item :label="$t('inviteUser.content.label4')" v-if="visiblePwd" prop="pwd">
            <div>
              <el-input
                ...
                :placeholder="$t('inviteUser.content.place1')"
              >
                <i
                  slot="suffix"
                  :title="$t('inviteUser.content.title1')"
                  @click="changePass('show')"
                  style="cursor:pointer;"
                  class="iconfont iconyanjingdingge"
                ></i>
              </el-input>
          ...
          <el-form-item v-else :label="$t('inviteUser.content.label4')" prop="pwd">
            <div>
              ...
              >
                <i
                  slot="suffix"
                  :title="$t('inviteUser.content.title2')"
          ...
          <el-form-item
            v-if="visible"
            :label="$t('inviteUser.content.label6')"
