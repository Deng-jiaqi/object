  ...
  <div class="c-createTransportData" v-show="pageInitializationRequestEnd">
    <div class="c-top">
      ...
      <span class="back" @click="back">
        ...
        {{$t('lang.managementFeeRate.text2')}}
      </span>
    </div>
    <!-- 错误提示框 -->
    ...
    <div class="box-product" v-show="isdefault">
      ...
      <div class="btm">
        ...
        <router-link
          to="/administratorPanel/settings/transport/shipping"
        >{{$t('lang.managementFeeRate.text73')}}</router-link>
      ...
      >
        <el-form :model="freight" :rules="freightRule" ref="form_freight">
          ...
          <span slot="footer" class="dialog-footer">
            ...
            >{{$t('lang.managementFeeRate.text66')}}</el-button>
            <el-button
              type="primary"
