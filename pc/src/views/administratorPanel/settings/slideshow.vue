<template>
  <div class="slideshow">
    ...
    <!--    轮播上传-->
    <el-dialog :title="$t('slideShow.elDialog.title')" :visible.sync="dialogVisibleImg" width="40%">
      <div>
          ...
          >
            ...
            <div class="disContent-hide">
              ...
              <el-tooltip
                ...
                placement="top"
              >
                <span class="Delete" @click="deleteImg(item,index)">
              ...
              <el-tooltip
                class="item"
                effect="dark"
                :content="$t('slideShow.elDialog.text1')"
                placement="top"
              >
                <span class="editCss" @click="editTitle(item, index)">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="saveUp" type="primary">{{$t('productLineDetail.elDialogPro.btn2')}}</el-button>
      </div>
    </el-dialog>
  </div>
</template>
