    ...
    <div class="content-createDiscountCode">
      ...
      <div class="box box-type">
        ...
        <div class="c-type-check">
          <el-radio v-model.number="pageInfo.type" :label="0">{{$t('lang.discountcode.text7')}}</el-radio>
        </div>
        <div class="c-type-check">
          <el-radio v-model.number="pageInfo.type" :label="1">{{$t('lang.discountcode.text8')}}</el-radio>
          <span></span>
        </div>
        <div class="c-type-check">
          <el-radio v-model.number="pageInfo.type" :label="2">{{$t('lang.discountcode.text9')}}</el-radio>
          <span></span>
        </div>
        <div class="c-type-check">
          <el-radio v-model.number="pageInfo.type" :label="3">{{$t('lang.discountcode.text10')}}</el-radio>
        </div>
      </div>
      <!-- 客户购买/消费框 -->
      <div class="box box-customer-buy" v-show="pageInfo.type===3">
        ...
        <div class="c-check">
          <div class="c-type-check">
            <el-radio
              v-model.number="pageInfo.xy_min_require"
              :label="2"
            >{{$t('lang.discountcode.text54')}}</el-radio>
          </div>
          <div class="c-type-check">
            <el-radio
              v-model.number="pageInfo.xy_min_require"
              :label="1"
            >{{$t('lang.discountcode.text55')}}</el-radio>
          </div>
        </div>
        <div class="box-customer-buy-top clearfix">
          <div class="c-input-customer-buy-number">
            <div v-show="pageInfo.xy_min_require===2">
              ...
              <el-input
                v-model.number="pageInfo.xy_min_goods_num"
                oninput="value=value.replace(/[^\d]/g,'')"
              ></el-input>
            </div>
            <div class="input-money" v-show="pageInfo.xy_min_require===1">
              <p class="text">{{$t('lang.discountcode.text57')}}</p>
              <el-input v-model.number="pageInfo.xy_min_money" @input.native="oninput"></el-input>
          ...
          <div class="select c-select-customer-buy">
            ...
            <el-select
              v-model.number="pageInfo.buy_type"
              :placeholder="$t('lang.discountcode.text59')"
            >
              <el-option
      ...
      <div class="box box-customer-get" v-show="pageInfo.type===3">
        <div class="box-customer-get-top">
          ...
          <div class="c-input-customer-get-number">
            <p class="text">{{$t('lang.discountcode.text56')}}</p>
            <el-input v-model.number="pageInfo.get_num" oninput="value=value.replace(/[^\d]/g,'')"></el-input>
          </div>
          <div class="select c-select-customer-get">
            <p class="text">{{$t('lang.discountcode.text58')}}</p>
            <el-select
              v-model.number="pageInfo.get_type"
              :placeholder="$t('lang.discountcode.text59')"
            >
              <el-option
                v-for="item in $i18n.locale==='zh-cn'?optionsZh:optionsEn"
      ...
      <div class="box box-geographical-position" v-show="pageInfo.type===2">
        <div class="box-geographical-position-top">
          ...
          <div class="c-search" v-show="pageInfo.discount_area!==0">
            <el-input
              ...
              :placeholder="$t('lang.discountcode.text92')"
              prefix-icon="iconfont icon-sousuo4"
            ></el-input>
        ...
        <div class="box-geographical-position-btm">
          ...
          <div class="c-discount-input-specific-amount" v-show="pageInfo.limit_shipping.status">
            <el-input
              v-model.number="pageInfo.limit_shipping.amount"
      ...
      <div class="box box-discounts-scope" v-show="pageInfo.type===0||pageInfo.type===1">
        <div class="box-discounts-scope-top">
          ...
          <div class="c-discount-input-percentage" v-show="pageInfo.type===0">
            <el-input v-model="pageInfo.discount_amount" @input.native="oninput1"></el-input>
            <!-- 百分比 -->
            <span class="percent">%</span>
          </div>
      ...
      <div class="box box-mini-Requirements" v-show="pageInfo.type!==3">
        ...
        <div class="c-type-check c-minimum-amount">
          ...
          <div class="c-minimum-amount-input" v-show="pageInfo.min_require===1">
            <!-- 金额 -->
            <el-input v-model.number="pageInfo.min_money" @input.native="oninput"></el-input>
            <span class="dollar">$</span>
          </div>
      ...
      <div class="box box-use-restrictions">
        ...
        <div class="c-type-check c-use-number">
          ...
          <div class="c-use-number-input">
            <el-input
              v-show="pageInfo.use_amount.status"
              v-model="pageInfo.use_amount.number"
              oninput="value=value.replace(/[^\d]/g,'')"
            ></el-input>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    submitValidate() {
      ...
      switch (this.pageInfo.type) {
        ...
        case 1: // 类型是百分比或者固定金额时
          ...
          if (this.pageInfo.suitable_for === 2 && this.pageInfo.type === 0) {
            // 适用于特定产品系列时候
          ...
          if (this.pageInfo.suitable_for === 2 && this.pageInfo.type === 1) {
            // 适用于特定产品系列时候
    ...
    oninput(e) {
      e.target.value = e.target.value.match(/^\d*(\.?\d{0,2})/g) || null
    },
    oninput1(e) {
      e.target.value = e.target.value.match(/^(?:[1-9]?\d|100)$/)
    },
