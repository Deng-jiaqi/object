    ...
    <header>
      <div class="header-box">
        <div>
          ...
          >{{$t('lang.templete.templeteEight.header.text1')}}</span>
        </div>
        <p class="header-title">{{$t('lang.templete.templeteEight.header.text2')}}</p>
        <div class="header-gouwu">
          <p>
            {{$t('lang.templete.templeteEight.header.text3')}}
            <span
              class="iconfont iconjiantouarrow483"
            ></span>
          </p>
          <p class="iconfont icongouwudai" style="cursor: pointer" @click="shopCart">
      ...
      <div class="header-box2">
        <div>
          <ul class="header-ul">
            <router-link
              v-for="(item, index) in $t('lang.templete.templeteEight.header.text5')"
              :key="index"
              :to="item.href"
