        ...
        <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm">
                    ...
                    <div>
                      <ul>
                        ...
                        >
                          <div>
                            <div>
                              <img :src="item.attr_img === '' ? missImage : item.attr_img" alt />
                            </div>
                            <p>{{item.attr_value}}</p>
                          </div>
                        </li>
                ...
                <el-col :span="11">
                  <div class="itemBox1">
                    <div class="multiple-box-Box1">
                      <img :src="img === '' ? missImage : img" alt />
                    </div>
                    <div>
                      <p class="text-hideFour">{{ruleForm.goodsname}}</p>
                      <p class="sizeCss">
          ...
          <div class="multiple-box box4Mul">
            ...
            <div class="genZongNum">
              ...
              >{{$t('mulAttrDetails.content.siteNum.text5')}}</el-checkbox>
            </div>
            <div class="mulBox4">
              <p></p>
              <div>
            ...
            <div class="mulBox4">
              <p>{{$t('mulAttrDetails.content.siteNum.text1')}}</p>
              <div>
                <span>{{$t('mulAttrDetails.content.siteNum.slot')}}</span>
              </div>
            </div>
...
import { showmultity, saveaddattr, showaddattr, editattrimg, saveattrupload, deletelocate, editmultlocation, savemultity } from '../../../common/api/api'
