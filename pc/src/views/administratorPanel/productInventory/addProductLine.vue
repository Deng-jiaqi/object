  ...
  <div class="productDetails">
    ...
    <div class="productDetails-form">
            ...
            <div class="imgBox">
              <div class="img-files" style="text-align: center" v-if="imgs.length < 1">
                ...
                <div class="img-file">
                  ...
                  >{{$t('addProductLine.content.text3')}}</label>
                </div>
              </div>
          ...
          <div class="add-type">
            <el-form-item>
              <el-radio
                ...
                label="0"
                class="radioCss"
              >{{$t('addProductLine.content.span2')}}</el-radio>
              <p class="proCaoZuo">
                {{$t('addProductLine.content.span3')}}
            ...
            <el-form-item>
              <el-radio
                ...
                label="1"
                class="radioCss"
              >{{$t('addProductLine.content.span5')}}</el-radio>
              <p class="proCaoZuo">
                {{$t('addProductLine.content.span6')}}
      ...
      <div class="btnCss">
        ...
        >{{$t('addProductLine.content.btn2')}}</el-button>
      </div>
    </div>
    <!--    编辑图片替换文字-->
    <el-dialog
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          v-preventReClick="2000"
        >{{$t('addProductLine.elDialogImg.btn2')}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
