        ...
        <div class="inventory-table">
          <table v-loading="loading" v-if="trData.length > 0">
            <thead>
              ...
              <!-- <th width="70px">{{$t('inventory.table.thead.th2')}}</th> -->
              <th width="230px">{{$t('inventory.table.thead.th3')}}</th>
              ...
              <tr v-for="(item, index) in trData" :key="index">
                ...
                <td class="td-imgBox">
                  ...
                  <div>
                    ...
                    >
                      <el-link class="text-link" type="primary">{{item.goodsname}}</el-link>
                    </p>
                    <p
                      class="linkA"
                      @click="item.attrpid !== 0 ? productDetails(item) : productDes(item)"
