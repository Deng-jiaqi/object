        ...
        <div class="inventory-table">
          <table v-if="judgeLength>0" v-loading="loading">
            <thead>
              ...
              <th width="120px" class="input-th1">{{$t('product.table.thead.th1')}}</th>
              <th width="110px">{{$t('product.table.thead.th2')}}</th>
              <th width="160px">{{$t('productLine.hint.text5')}}</th>
              ...
              <tr v-for="(item, index) in allProducts" :key="index" @click="routerDetails(item)">
                ...
                <td class="td-imgBox">
                  ...
                  <div class="td-text-hide">
                    <span class="text-hide">{{item.goodsname}}</span>
                    <br />
                    <br />
                    <span class="text-hide-p">{{item.status}}</span>
                  </div>
                </td>
                <td width="300px">
                  <p>
                ...
                <td style="color: #FFA400" width="30px">
                ...
                <td>
                  <span>{{$t('product.table.tbody.text2')}}</span>
                </td>
              </tr>
            </tbody>
          </table>
