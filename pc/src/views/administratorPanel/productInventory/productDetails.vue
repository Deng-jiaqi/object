      ...
      <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" class="add-form">
        ...
        <el-form-item v-if="is_more_attribute === 0">
          <div class="multiple-box">
            <div>
              <p
                class="productDetails-text multiple-box-productDetails-text"
              >{{$t('productDetails.repertory.span2')}}</p>
              <el-row>
                <el-col :span="11">
            ...
            <div class="checkBox-css">
              ...
              <!-- <br /> -->
              <el-checkbox
                class="checkbox-text4"
                v-if="gzCheckbox === true"
              >{{$t('productDetails.repertory.text4')}}</el-checkbox>
            </div>
            <div class="mulBox4">
              <p></p>
              <div>
            ...
            <div class="mulBox4">
              <p>{{$t('productDetails.repertory.title')}}</p>
              <div>
                <span>{{$t('productDetails.repertory.text5')}}</span>
              </div>
            </div>
            <!-- 输入后的位置地址 -->
            <ul>
                        ...
                        <label class="flexCss">
                          ...
                          <span v-else>
                            ...
                            <el-popover placement="bottom" trigger="click">
                              ...
                              <el-button
                                slot="reference"
                                class="el-icon-edit el-icon-edit-btn"
      ...
      >
        ...
        <ul>
          <li v-for="(item, index) in checkedEdit" :key="index" class="checkBox-css">
            <template>
              <el-checkbox-group v-model="item.checked" :min="1" :max="3">
        ...
        <span slot="footer" class="dialog-footer">
          <div class="leftBtn-footer">
            ...
            <div v-if="hideBtn">
              ...
              >{{$t('productDetails.haveElDialogImg.btn2')}}</el-button>
...
.multiple-box-productDetails-text {
  margin-top: -30px;
}
.el-icon-edit-btn {
  margin-left: 20px;
