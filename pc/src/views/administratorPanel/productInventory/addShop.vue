      ...
      <el-form class="add-form" ref="ruleForm" :rules="rules" :model="ruleForm">
        ...
        <el-form-item>
          ...
          <div class="hide-tail">
            ...
            >{{$t('addShop.repertory.text4')}}</el-checkbox>
          </div>
          <br />

          <div class="editWarehouse" v-if="warehouseData.length>0">
            <div
              style="border-bottom: 1px solid #e3e3e3;line-height:ctnter"
              class="editWarehouse-box1"
            >
              <span></span>
              <span
            ...
            <div class="editWarehouse-box1">
              <span>{{$t('addShop.repertory.text9')}}</span>
                        ...
                        <label class="flexCss">
                          ...
                          <span v-else>
                            ...
                            <el-popover placement="bottom" trigger="click">
                              ...
                              >{{$t('addShop.multiAttribute.btn2')}}111</el-button>
                            </el-popover>
                          </span>
                        </label>
                      </div>
...
import {
  ...
  formatMoney,
  validateValue
} from '../../../common/validator' // 中文正则
import { EvalidateValue } from '../../../common/enValidator' // 英文正则
