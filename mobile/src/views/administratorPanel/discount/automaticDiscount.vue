    ...
    <div class="content-createAutomaticDiscount">
      ...
      <div class="box box-discounts-scope" v-show="pageInfo.type===0||pageInfo.type===1">
        ...
        <div class="box-discounts-scope-btm">
          ...
          <!-- 固定金额时的搜索框 -->
          <div class="box-discounts-scope-btm-search c-search" v-show="pageInfo.type===1&&pageInfo.suitable_for===1">
            <el-input
          ...
          <div class="box-discounts-scope-btm-search c-search" v-show="pageInfo.type===1&&pageInfo.suitable_for===2">
            <el-input
      ...
      <!-- 最低要求 -->
      <div class="box box-mini-Requirements">
        <p class="title">{{$t('lang.autoDiscountcode.text37')}}</p>
        <div class="c-type-check c-minimum-amount">
          <el-radio
            v-model="pageInfo.min_require"
            :label="1"
          >{{$t('lang.autoDiscountcode.text38')}} (￥)</el-radio>
          <div class="c-minimum-amount-input" v-show="pageInfo.min_require===1">
            <el-input v-model="pageInfo.min_money" @input.native="oninput"></el-input>
            <span class="dollar">$</span>
          </div>
          <p class="tip1">{{$t('lang.autoDiscountcode.text39')}}</p>
        </div>
        <div class="c-type-check c-minimum-quantity">
          <el-radio v-model="pageInfo.min_require" :label="2">{{$t('lang.autoDiscountcode.text40')}}</el-radio>
          <div class="c-minimum-quantity-input" v-show="pageInfo.min_require===2">
            <el-input v-model="pageInfo.min_goods_num" oninput="value=value.replace(/[^\d]/g,'')"></el-input>
          </div>
          <p class="tip2">{{$t('lang.autoDiscountcode.text41')}}</p>
        </div>
      </div>
      <!-- 生效日期 -->
