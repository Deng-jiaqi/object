<template>
  <div class="c-orderDetails" v-if="pageInfo">
    <div class="content-orderDetails">
      ...
      <p class="time">{{pageInfo.headinfo.createtime}}</p>
      ...
      <div class="c-good-info" v-if="pageInfo.notshiped">
        <div class="top">
          ...
          <div class="good" v-for="(item,index) in pageInfo.notshiped.info" :key="index">
            ...
            <p class="good-amount">${{item.amount}}</p>
          </div>
        </div>
        ...
        <div class="one" v-for="(item,index) in pageInfo.shiped" :key="index">
          <div class="top">
            ...
            <div class="good" v-for="(itemTwo,indexTwo) in item.info" :key="indexTwo">
              ...
              <span class="good-price">${{itemTwo.price}}</span>
            </div>
          </div>
          <div class="btm clearfix">
      ...
      <div class="c-good-info" v-if="pageInfo.refunded">
        <div class="top">
          ...
          <div class="good" v-for="(item,index) in pageInfo.refunded.info" :key="index">
            <div class="left">
              <img :src="item.img" alt />
              <div class="info">
                <p class="title">{{item.goodsname}}</p>
      ...
      <div class="c-user-info">
        ...
        <div class="box-contact-information">
          <div class="box-contact-information-top">
      ...
      <div class="c-shipping-adress">
        <div class="c-shipping-adress-top">
        ...
        <ul>
          <li v-for="(item,index) in pageInfo.order_history" :key="index" class="myli clearfix">
            ...
            <div class="info clearfix">
              <div class="schedule-time">{{item.operate_time}}</div>
    ...
    <div class="c-AddTraceInformation">
      ...
      >
        ...
        >
          ...
          <div class="c-notify">
            <el-checkbox class="el-checkbox" v-model="notifyUser" />
    ...
    <div class="note-modal-window">
      <el-dialog :title="$t('lang.orderDetails.text30')" :visible.sync="editorNoteVisible">
        ...
        <span slot="footer">
          ...
          <el-button type="primary" @click.native="editorNote">{{$t('lang.orderDetails.text59')}}</el-button>
        </span>
      </el-dialog>
    </div>
    <!-- 编辑用户联系信息模态窗 -->
...
export default {
  ...
  methods: {
    ...
    openAddTraceInformationModal (index) {
      ...
      this.addTraceInformation.courier = this.pageInfo.shiped[index].deliver_method
      this.addTraceInformation.deliverNumber = this.pageInfo.shiped[index].deliver_order
      this.pageInfo.shiped[index].info.forEach(item => {
        this.Id.push(item.Id)
      })
    ...
    async confirmReceipt () {
      ...
      if (res.data.code === 1) {
        ...
        this.$set(this.pageInfo, 'order_status', res.data.data.order_status)
      }
    }
  },
  created () {
