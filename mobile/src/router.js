...
export default new Router({
  ...
  routes: [
    //  登录注册
    {
      ...
      component: resolve => require(['@/components/loginAndRegister/layout'], resolve),
      children: [{
        path: 'EloginOfMall',
        name: 'EloginOfMall',
    ...
    },
    {
      ...
      name: 'templateFive',
      component: resolve => require(['@/views/administratorPanel/onlineStore/templateFiveLayout'], resolve),
      children: [{
        path: '/templateFiveContent',
        name: 'templateFiveContent',
        component: resolve => require(['@/components/template/templateFiveContent/index'], resolve)
      },
      {
        path: '/productDetails',
        name: 'productDetails',
      ...
      {
        path: '/listDetailsFive/:id',
        name: 'listDetailsFive',
        component: resolve => require(['@/components/template/listDetails'], resolve)
      }
      ]
    },
    {
      ...
      //   name: 'shopDetailsSix',
      //   component: () => import('@/components/template/shopDetails')
      // },
      {
      ...
      //   name: 'shopProductSix',
      //   component: () => import('@/components/template/shopProduct')
      // },
      {
    ...
    // 简化模板第三套
    {
      ...
      children: [
        ...
        //   component: resolve => require(['@/components/template/shopDetails'], resolve)
        // },
        {
        ...
        //   component: resolve => require(['@/components/template/shopProduct'], resolve)
        // },
        {
    ...
    {
      path: '/www',
      component: () => import('@/views/administratorPanel/onlineStore/ifream')
    },
    {
      path: '',
      redirect: '/dashbord'
