    ...
    <div class="c-catalog">
      ...
      <div>
        <div class="Product-content" v-if="catalogInfo.WhetherToDisplayOrder">
          <div>
            <span class="sortby">{{$t('shopProduct.content.text1')}}</span>
            <el-select
              v-model="sortingWay"
